...
export class DotPainter {
  ...
  paint(context, geometry, properties) {
    ...
    this.draw(context, geometry);
  }

  setParam(context2d, colorTL, colorTR, colorBL, colorBR, dotSize, span, geometry) {
    ...
    this.draw(context2d, geometry);
  }

  draw(context, geometry) {

    const colorTL = this.coloTL;
    const colorTR = this.colorTR;
    const colorBL = this.colorBL;
    const colorBR = this.colorBR;
    ...
    console.log(gridNumHorizontal, gridNumVertical);
